...
exports.mongolizer = function(
  ...
  ////Mongodb connection//////
  mongo.connect(mongodb_connection_string,{ useNewUrlParser: true }, function(err, client) {
    let db = client.db(dbName);// mongod v.3 According to the changelog for 3.0 you now get a client object containing the database object instead:
